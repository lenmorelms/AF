        ...
        {isTokenValid() ? (
          <div style={styles.profileContainer}>
            <button style={styles.profileButton} onClick={toggleDropdown}>
              {userData && userData.username} <FaChevronDown style={styles.dropdownIcon} />
            </button>
            {dropdownOpen && (
              <div style={styles.dropdown}>
                <Link to="/profile"><button style={styles.logoutButton}>Profile</button></Link>
                <button style={styles.logoutButton} onClick={logoutHandler}>Signout</button>
              </div>
            )}
          </div>
        ) : (
