...
predictionRouter.route("/:tournamentId/rounds").get(protect, asyncHandler(async (req, res) => {
    try {
...
predictionRouter.route("/:tournamentId/:userId/:round").get(protect, asyncHandler(async (req, res) => {
    try {
        const tournamentId = req.params.tournamentId;
        const userId = req.params.userId;
...
predictionRouter.route("/:tournamentId/:userId").post(protect, asyncHandler(async (req, res) => {
    try {
...
predictionRouter.route("/:tournamentId/:round/:fixtureId/:userId").put(protect, asyncHandler(async (req, res) => {
    try {
        // 
    } catch (err) {
        console.error(err.message);
